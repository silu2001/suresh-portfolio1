...
export const AntiGravityCanvas: React.FC = () => {
  ...
  return (
    <div 
      ref={containerRef} 
      className="fixed inset-0 z-0 overflow-hidden bg-transparent pointer-events-none"
      style={{ zIndex: -1 }}
    >
      <canvas ref={canvasRef} className="block w-full h-full" />
      
      {/* Debug Info Overlay (Hidden in production usually, but cool for tech demos) */}
      <div className="absolute bottom-4 right-4 pointer-events-none text-xs text-white/20 font-mono text-right hidden">
